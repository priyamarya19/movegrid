      ...
      <div className="max-w-7xl mx-auto px-5 sm:px-8 pt-14 pb-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-10 mb-12">
          ...
          <div className="lg:col-span-2">
            ...
            {/* Social media & directory icons */}
            <div className="mt-5 flex items-center gap-3">
              <a
                href="https://www.instagram.com/movegrid?igsh=a3J3djZiZDNtaWd0"
                target="_blank"
                rel="noopener noreferrer"
                aria-label="MoveGrid on Instagram"
                className="w-8 h-8 rounded-lg bg-[var(--bg-card)] border border-[var(--border)] flex items-center justify-center text-[var(--text-muted)] hover:text-[#E1306C] hover:border-[#E1306C]/40 transition-colors"
              >
              ...
              <a
                href="https://www.linkedin.com/company/movegrid/"
                target="_blank"
                rel="noopener noreferrer"
                aria-label="MoveGrid on LinkedIn"
                className="w-8 h-8 rounded-lg bg-[var(--bg-card)] border border-[var(--border)] flex items-center justify-center text-[var(--text-muted)] hover:text-[#0A66C2] hover:border-[#0A66C2]/40 transition-colors"
              >
                <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor">
              ...
              <a
                href="https://www.facebook.com/profile.php?id=61589003842416&sk=about"
                target="_blank"
                rel="noopener noreferrer"
                aria-label="MoveGrid on Facebook"
                className="w-8 h-8 rounded-lg bg-[var(--bg-card)] border border-[var(--border)] flex items-center justify-center text-[var(--text-muted)] hover:text-[#1877F2] hover:border-[#1877F2]/40 transition-colors"
              >
                <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor">
              ...
              <a
                href="https://share.google/nfMCODToIWYwYSGXU"
                target="_blank"
                rel="noopener noreferrer"
                aria-label="MoveGrid on Google"
                className="w-8 h-8 rounded-lg bg-[var(--bg-card)] border border-[var(--border)] flex items-center justify-center text-[var(--text-muted)] hover:text-[#EA4335] hover:border-[#EA4335]/40 transition-colors"
              >
                <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor">
